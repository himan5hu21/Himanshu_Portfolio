...
function About() {
  return (
    <Element name="about" className="py-5 px-6 md:py-10 md:px-12">
      <h1 className="text-4xl font-bold text-center text-sky-600">About Me</h1>
      <section
        id="about"
      ...
      >
        ...
        <div className="flex flex-col gap-5 text-justify">
          ...
          <p>
            ...
            Express.js, MongoDB, SQL, HTML, and CSS. Whether it&#39;s designing
            user-friendly interfaces or building scalable backend systems, I
          ...
          <p>
            Feel free to explore my portfolio and projects to see what I&#39;ve
            been working on!
          </p>
        </div>
      </section>
